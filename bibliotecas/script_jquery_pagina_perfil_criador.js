$(function(){
    ...
    // Todas áreas estarão escondidas, exceto a de publicações que será a inicial
    $('#area_publicacoes').show();
    $('#area_sobre').hide();
    $('#area_amigos').hide();
    $('#area_doar').hide();
    ...
    // Todas as opções do menu de informações não estarão selecionadas, exceto a de publicações
    $('#publicacoes').css("background-color", "black");
    ...
    $('#sobre').click(function(){
        $('#publicacoes').css("background-color", "rgba(0, 0, 0, 0.5)");
