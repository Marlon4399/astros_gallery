...
<body>
    ...
    <h1 id="titulo_confirmacao_dados">Confirmação de Dados - Cartão de Débito</h1>
    ...
    <div class="area_alteracao_pagamento">
        <div class="opcao_pagamento_credito">
            ...
            <form id="form_credito">
                <img src="../imgs/cartao_debito.png" style="border-radius: 0px; width: 250px; height: 200px; border: 10px solid goldenrod; background-image: -webkit-linear-gradient( right, rgb(68, 0, 255), rgb(184, 35, 221)); padding: 10px;"><br>
